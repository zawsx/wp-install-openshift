# WordPress on OpenShift copied from https://github.com/openshift/wordpress-example #

The easiest way to install this application is to use the [OpenShift
Instant Application][template]. To install manually, follow [these directions](#manual-installation).
...
wp-config.php is located at `.openshift/config/wp-config` within your project 
...
If you'd like to check these into source control, download the plugins and themes directories and then check them directly into 
...
Create a php-5.4 application (you can call your application whatever you want)
    ...
    rhc app create wordpress php-5.4 mysql-5.5 --from-code=https://github.com/zawsx/wp-install-openshift
